...
import com.imer1c.api.minecraft.chatting.text.INBTTextComponent;
import com.imer1c.utils.UnSetBoolean;

public class NBTTextComponent extends TextComponent implements INBTTextComponent {

    private final String nbt;
    private String entity, block, storage;
    private UnSetBoolean interpret;

    public NBTTextComponent(String nbt)
    {
        super(null);
        this.nbt = nbt;
    }
